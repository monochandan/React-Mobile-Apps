import { Dimensions, FlatList, ScrollView, StyleSheet, Text, View, Image, Platform, TouchableOpacity } from 'react-native';
...
const Property = () => {
    ...
    //custome hook call for fetching the data 
    ...
    // console.log("output: ",propertyDetails)
    // console.log("Property images: ", propertyDetails[0].image)
    //console.log(propertyDetails[0].image)
    // console.log("agent id: ", propertyDetails[0].agent)
  return (
    ...
    <View>
        ...
        >
            <View className='mt-11 relative w-full' style={{height: windowHeight / 2}}>
            ...
            <View className='px-5 mt-7 flex gap-2'>
                ...
                <View className="flex flex-row items-center gap-2">
                  ...
                  <Text className="text-black-200 text-sm mt-1 font-rubik-medium">
                    {propertyDetails?.rating} (1000 reviews)
                  </Text>
              </View>
            </View>
          ...
          {propertyDetails?.facilities.length > 0 && (
            <View className='flex flex-row flex-wrap items-start justify-start mt-2 gap-5'>
              ...
              {propertyDetails?.facilities.map((item:string, index:number) =>{
          ...
          {propertyDetails?.gallery.length > 0 ? (
            <View className='mt-7'>
              <Text className='text-black-300 text-xl font-rubik-bold'>
                Gallery
              </Text>
          ...
          {/* {propertyDetails?.reviews.length > 0 ? (
            <View className="mt-7">
              ...
              <View className="mt-5">
                <Comment item={propertyDetails?.reviews[0]} />
              </View>
            </View>
          ):
          <NoResults/>
